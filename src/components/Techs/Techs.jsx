      ...
      <div className="mt-10  s:mt-[60px]">
        <div className="flex ps-4  flex-col">
          ...
          <p className=" xl:w-[50%] xl:pb-4  font-poppins   antialiased s:hidden text-left ">
            In the "Tech" section of my portfolio, I showcase a 
            experience with React for creating dynamic and user-friendly
            interfaces. On the backend, I've worked with PHP Laravel, LiveWire to
            build reliable and interactive features. 🛠️ As a junior developer,
            I'm continually honing my skills and excited about the journey ahead
            in the world of web development! 🚀
          </p>
        </div>
        {/* The  DIV OF DIFFRENT STACKS   */}
        <div className=" s:grid s:grid-rows-3 s:gap-y-12   py-4 xl:grid xl:grid-cols-3  lg:grid lg:grid-cols-3  ">
          ...
          <div className=" flex flex-col    gap-y-4 items-center s:mb-4 md:mb-4   ">
            <div className=" s:flex s:self-start   ">
              ...
              <h3 className=" antialiased font-popins hidden s:flex text-left text-4xl font-semibold md:hidden ">
                Front End
              </h3>
            </div>
            ...
            <div className="  s:border-b-8  s:border-b-orange-600 s:my-0  s:py-0  mx-auto s:w-[50%] xl:hidden " />
          </div>
          ...
          <div className=" flex flex-col    gap-y-4 items-center s:mb-4   ">
            <div className=" s:flex s:gap-x-2 s:self-start">
              <SiAltiumdesigner
                ...
                size="3rem"
              />
              <h3 className=" hidden s:flex text-left text-4xl font-semibold md:hidden  ">
                UI / UX
              </h3>
            </div>
            <h3 className="  antialiased font-popins s:hidden text-left text-4xl font-semibold md:hidden  ">
